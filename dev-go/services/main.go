...
import (
	...
	s_web_flights "github.com/cottand/selfhosted/dev-go/services/s-web-flights"
...
func main() {
	bedrock.Register(s_rpc_autoscaler.InitService)
	bedrock.Register(s_rpc_flights.InitService)
	bedrock.Register(s_rpc_mqtt.InitService)
	...
	bedrock.Register(s_web_flights.InitService)
