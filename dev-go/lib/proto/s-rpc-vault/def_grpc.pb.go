...
func (c *vaultApiClient) Snapshot(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, VaultApi_Snapshot_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedVaultApiServer must be embedded to have
...
func (UnimplementedVaultApiServer) testEmbeddedByValue()                  {}
...
func RegisterVaultApiServer(s grpc.ServiceRegistrar, srv VaultApiServer) {
	// If the following call panics, it indicates UnimplementedVaultApiServer was
