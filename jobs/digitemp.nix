  ...
  job."digitemp" = {
    ...
    group."${name}" = {
      ...
      task."${name}" = {
        ...
        config = {
          image = "ghcr.io/anibali/digitemp-exporter:${version}";
          privileged = true;
          mounts = [{
            type = "bind";
            source = "/dev/ttyUSB0";
        ...
        resources = {
          ...
          # presumably, the temperature sensor
          # https://www.tindie.com/products/kel/usb-thermometer/
          # USB connection based on genuine DS18B20+ 1–wire probe and PL-2303GL serial interface
          device."067b/usb/23a3" = { };
        };
      };
    };
  };
